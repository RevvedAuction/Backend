...
public class IndividualFactoryTest {
    ...
    private static Individual individual2 = IndividualFactory.createIndividual(123, "John", "Doe", "inathi@gmail.com", LocalDate.of(1990, 5, 8), 123456789, "123456789", "123 Main St");
